...
We have other  [repositories](https://github.com/Vandit1604/StateYourName) that you can contribute to. If you would like to join our GitHub Open Source
...
[![Watch The Video By Eddie Jaoude](https://user-images.githubusercontent.com/61582763/94226800-1d0d5d80-ff16-11ea-8097-689ec7b5af69.png)](https://youtu.be/tjH6txTiC6E)
...
-Click the green New Pull Request button. This will prep the new pull request for you by auto-filling the base repository: base with 'StateYourName: main' AND auto-filling your head repository: compare with your repository: main
...
- **Add your name to the section that matches your Initial in [this list](https://github.com/Vandit1604/StateYourName/blob/main/README.md), make sure that your name is in alphabetical order. Then save your changes.**
...
```bash
ERROR: Permission Vandit1604/StateYourName.git denied to <your-github-username>.
...
- You can also ask for help in our [Discord server](https://discord.gg/u9rH2BzF)

---

## `GFG Hacktoberfest Pull 'N Merge`
